...
def find_strokes_indices(player_1_boxes, player_2_boxes, ball_positions, skeleton_df, verbose=0):
    ...
    #added script
    player_2_x = np.array(player_2_x, dtype=np.float)
    player_2_x = player_2_x[~np.isnan(player_2_x)]
    player_2_y = np.array(player_2_y, dtype=np.float)
    player_2_y = player_2_y[~np.isnan(player_2_y)]
